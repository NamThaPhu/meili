<?php
    $url='https://shopee.vn/api/v4/search/search_items?by=pop&limit=40&match_id=406356404&newest=0&order=desc&page_type=shop&scenario=PAGE_OTHERS&version=2'; // tạo biến url cần lấy
